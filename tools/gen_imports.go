...
var resources = []ResourceImport{
	...
	{Name: "seerr_emby_library_settings", ExampleID: "1", Hint: "The library ID."},
	{Name: "seerr_emby_settings", ExampleID: "emby"},
	{Name: "seerr_issue", ExampleID: "1", Hint: "The issue ID."},
	{Name: "seerr_issue_comment", ExampleID: "1", Hint: "The comment ID."},
	{Name: "seerr_jellyfin_library_settings", ExampleID: "1", Hint: "The library ID."},
	...
	{Name: "seerr_metadata_settings", ExampleID: "metadata"},
	{Name: "seerr_network_settings", ExampleID: "network"},
	...
	{Name: "seerr_override_rule", ExampleID: "1", Hint: "The rule ID."},
	{Name: "seerr_plex_library_settings", ExampleID: "1", Hint: "The library section ID."},
	...
	{Name: "seerr_request", ExampleID: "1", Hint: "The request ID."},
	{Name: "seerr_request_approval", ExampleID: "1", Hint: "The request ID to approve/decline."},
	...
	{Name: "seerr_user_invitation", ExampleID: "1", Hint: "The invitation ID."},
	{Name: "seerr_user_notification_settings", ExampleID: "1", Hint: "The ID of the user."},
	{Name: "seerr_user_permissions", ExampleID: "1", Hint: "The ID of the user."},
	{Name: "seerr_user_quota", ExampleID: "1", Hint: "The ID of the user."},
	...
	{Name: "seerr_watchlist", ExampleID: "1", Hint: "The watchlist item ID."},
}
