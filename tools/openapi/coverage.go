...
func DefaultRules() []PathRule {
	return []PathRule{
		...
		{PathPattern: "/request/{requestId}/{status}", Classification: ClassCovered, MappedResource: "seerr_request_approval", Notes: "Request approval resource"},
		...
		{PathPattern: "/issue/{issueId}/comment", Classification: ClassCovered, MappedResource: "seerr_issue_comment", Notes: "Issue comment creation"},
		{PathPattern: "/issueComment/{commentId}", Classification: ClassCovered, MappedResource: "seerr_issue_comment", Notes: "Issue comment item resource"},
		...
		{PathPattern: "/settings/plex/devices/servers", Classification: ClassCovered, MappedResource: "seerr_plex_devices", Notes: "Transient device discovery endpoint for Plex"},
		...
		{PathPattern: "/settings/notifications/email/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/discord/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/pushbullet/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/pushover/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/pushover/sounds", Classification: ClassCovered, MappedResource: "seerr_pushover_sounds", Notes: "Pushover notification sounds data source"},
		{PathPattern: "/settings/notifications/gotify/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/ntfy/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/slack/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/telegram/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/webhook/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/notifications/webpush/test", Classification: ClassCovered, MappedResource: "seerr_notification_agent_test", Notes: "Notification agent test action resource"},
		{PathPattern: "/settings/about", Classification: ClassCovered, MappedResource: "seerr_about", Notes: "System diagnostics and about data source"},
