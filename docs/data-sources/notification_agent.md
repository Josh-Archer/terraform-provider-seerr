...
output "ntfy_topic" {
  value = data.seerr_notification_agent.ntfy.ntfy.topic
}

output "ntfy_embed_poster" {
  value = data.seerr_notification_agent.ntfy.embed_poster
}

data "seerr_notification_agent" "pushover" {
  agent = "pushover"
}

output "pushover_sound" {
  value = data.seerr_notification_agent.pushover.pushover.sound
}
```
