...
var _ datasource.DataSource = &SonarrRootFoldersDataSource{}

type SonarrRootFoldersDataSource struct{}

type SonarrRootFolderModel struct {
...
type SonarrRootFoldersDataSourceModel struct {
	...
	RootFolders []SonarrRootFolderModel `tfsdk:"root_folders"`
}

func NewSonarrRootFoldersDataSource() datasource.DataSource {
	return &SonarrRootFoldersDataSource{}
}

func (d *SonarrRootFoldersDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_sonarr_root_folders"
}

func (d *SonarrRootFoldersDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Fetch Sonarr root folders via /api/v3/rootfolder.",
		Attributes: map[string]schema.Attribute{
			...
			"root_folders": schema.ListNestedAttribute{
				MarkdownDescription: "List of root folders from Sonarr.",
				Computed:            true,
...
func (d *SonarrRootFoldersDataSource) Configure(_ context.Context, _ datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
}

func (d *SonarrRootFoldersDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
