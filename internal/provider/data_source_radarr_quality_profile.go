...
var _ datasource.DataSource = &RadarrQualityProfileDataSource{}

type RadarrQualityProfileDataSource struct{}

type RadarrQualityProfileDataSourceModel struct {
...
func NewRadarrQualityProfileDataSource() datasource.DataSource {
	return &RadarrQualityProfileDataSource{}
}

func (d *RadarrQualityProfileDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_radarr_quality_profile"
}

func (d *RadarrQualityProfileDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Look up a Radarr quality profile by name via /api/v3/qualityprofile.",
		Attributes: map[string]schema.Attribute{
			"name": schema.StringAttribute{
				MarkdownDescription: "The Radarr quality profile name to match exactly.",
				Required:            true,
			},
			...
			"api_key": schema.StringAttribute{
				MarkdownDescription: "Radarr API key used to read quality profiles.",
				Required:            true,
				Sensitive:           true,
			},
...
func (d *RadarrQualityProfileDataSource) Configure(_ context.Context, _ datasource.ConfigureRequest, _ *datasource.ConfigureResponse) {
}

func (d *RadarrQualityProfileDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data RadarrQualityProfileDataSourceModel
