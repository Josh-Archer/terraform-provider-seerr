...
func TestSonarrRootFoldersDataSourceRead(t *testing.T) {
	srv := httptest.NewServer(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		...
		_, _ = w.Write([]byte(`[
			{"id": 1, "path": "/tv", "accessible": true, "freeSpace": 123456789},
			{"id": 2, "path": "/anime", "accessible": false, "freeSpace": 987654321}
		]`))
	}))
	defer srv.Close()
	...
	// We need a Schema to decode into State
	...
	if data.RootFolders[0].ID.ValueInt64() != 1 || data.RootFolders[0].Path.ValueString() != "/tv" || data.RootFolders[0].Accessible.ValueBool() != true || data.RootFolders[0].FreeSpace.ValueInt64() != 123456789 {
