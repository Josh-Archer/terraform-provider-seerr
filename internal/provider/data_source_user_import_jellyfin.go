...
var _ datasource.DataSource = &UserImportJellyfinDataSource{}

type UserImportJellyfinDataSource struct {
	client *APIClient
}

type UserImportJellyfinDataSourceModel struct {
	ID            types.String `tfsdk:"id"`
	ImportedUsers types.List   `tfsdk:"imported_users"`
	ImportedCount types.Int64  `tfsdk:"imported_count"`
}

func NewUserImportJellyfinDataSource() datasource.DataSource {
	return &UserImportJellyfinDataSource{}
}

func (d *UserImportJellyfinDataSource) Metadata(_ context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_user_import_jellyfin"
}

func (d *UserImportJellyfinDataSource) Schema(_ context.Context, _ datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Read users imported from a connected Jellyfin server.",
		Attributes: map[string]schema.Attribute{
			...
			"imported_count": schema.Int64Attribute{
				MarkdownDescription: "Number of Jellyfin users imported.",
				Computed:            true,
			},
		},
	}
...
func (d *UserImportJellyfinDataSource) Configure(_ context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (d *UserImportJellyfinDataSource) Read(ctx context.Context, _ datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data UserImportJellyfinDataSourceModel
	...
	data.ID = types.StringValue("jellyfin_users")
